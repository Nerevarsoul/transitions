from transitions.aio import AsyncMachine


class AsyncStuff(object):

    def __init__(self, states=None, machine_cls=AsyncMachine, extra_kwargs={}):
...
class AsyncInheritedStuff(AsyncMachine):

    def __init__(self, states, initial='A'):

        self.state = None

        AsyncMachine.__init__(self, states=states, initial=initial)
